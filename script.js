...
// Parallax Effect on List Images (Initialize after content loads)
function initListParallax() {
...
window.addEventListener('cineverse:content-loaded', initListParallax)

// Card Tilt Effect (Initialize after content loads)
...
// Initialize on content loaded
window.addEventListener('cineverse:content-loaded', initCardTilt)
...
// Stagger Animation for Cards (Initialize after content loads)
...
window.addEventListener('cineverse:content-loaded', initCardAnimations)

// Also try on DOMContentLoaded as fallback
document.addEventListener('DOMContentLoaded', () => {
  setTimeout(initCardAnimations, 1000) // Wait 1s for Supabase data
})
